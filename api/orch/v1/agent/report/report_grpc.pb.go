...
const (
	ReportService_Report_FullMethodName = "/agent.reoprt.ReportService/Report"
)
...
type ReportServiceClient interface {
	...
	Report(ctx context.Context, in *Status, opts ...grpc.CallOption) (*ReportResponse, error)
}
...
func (c *reportServiceClient) Report(ctx context.Context, in *Status, opts ...grpc.CallOption) (*ReportResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReportResponse)
	err := c.cc.Invoke(ctx, ReportService_Report_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReportServiceServer interface {
	// Report the status of an agent
	Report(context.Context, *Status) (*ReportResponse, error)
...
func (UnimplementedReportServiceServer) Report(context.Context, *Status) (*ReportResponse, error) {
...
func _ReportService_Report_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReportServiceServer).Report(ctx, req.(*Status))
	}
...
var ReportService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "agent.reoprt.ReportService",
	...
	Metadata: "orch/v1/agent/report/report.proto",
}
